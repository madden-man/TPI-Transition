    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" style="float: right; width: 85%;">
        <div class="carousel-item active">
          ...
          <h1 style="color: #ffffff; position: absolute; top: 70%; left: 60%">Fancy Title: Individuals</h1>
        </div>
        <div class="carousel-item">

          <img src="img/fpo.jpg" style="width: 100%; height: 520px;" alt="Background Picture">

          <h1 style="color: #ffffff; position: absolute; top: 70%; left: 60%">Fancy Title: Families</h1>
        </div>
        <div class="carousel-item">
          
          <img src="img/fpo.jpg" style="width: 100%; height: 520px;" alt="Background Picture">
        
          <h1 style="color: #ffffff; position: absolute; top: 70%; left: 60%">Fancy Title: Employers</h1>
